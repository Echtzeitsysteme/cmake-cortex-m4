...
void cppp_writeFloat(float number, uint8_t precision, uint8_t width) {
    ...
    //TODO(Rennorb 22-09-19T00:19) this does not link. it requires __aeabi_f2d which seems to not exist.
    // figure out why it is even required and how to solve the linking issue
